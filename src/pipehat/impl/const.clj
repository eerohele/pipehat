...
(def ^{:const true :doc "The HL7 Minimal Lower Layer Protocol (MLLP) start block character."} SB 11)
(def ^{:const true :doc "The HL7 Minimal Lower Layer Protocol (MLLP) end block character."} EB 28)
